...
int main(int argc, string argv[])
{
    ...
    {
        printf("NUMERO MAXIMO DE CANDIDATOS Ã‰ %i\n", MAX_CANDIDATES);
        return 2;
    }
    ...
    {
        printf("NUMERO MAXIMO DE ELEITORES Ã‰ %i\n", MAX_VOTERS);
        return 3;
    }
    ...
    {
        //CONSULTA CLASSIFICAÃ‡ÃƒO
        for (int j = 0; j < candidate_count; j++)
        {
            string name = get_string("CLASSIFICAÃ‡ÃƒO %i: ", j + 1);
...
// PREFERENCIA DE REGISTRO DE VOTO VÃLIDO
bool vote(int voter, int rank, string name)
